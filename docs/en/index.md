...
- [Report]({{ "/docs/en/report/00-index" | relative_url }}) — the full project report: context, problem statement, research question, objectives, methodology, theoretical framework, schedule, development, and references
- [Documentation]({{ "/docs/en/manual/00-index" | relative_url }}) — the technical replication manual: system architecture, Robot AGV, Server/NUC, XR Meta Quest, commissioning, safety, troubleshooting, and more
