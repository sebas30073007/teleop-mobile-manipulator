...
1. Inicia en [Introducción académica]({{ "/docs/02-manual/01-introduccion" | relative_url }}).
2. Continúa con [Objetivo y alcance]({{ "/docs/02-manual/02-objetivo-alcance" | relative_url }}) y [Arquitectura general]({{ "/docs/02-manual/03-arquitectura-general" | relative_url }}).
