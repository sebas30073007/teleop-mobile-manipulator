...
4. [Validación del sistema]({{ "/docs/02-manual/06-validacion/" | relative_url }}) — experimentos, métricas, resultados
5. [Puesta en marcha]({{ "/docs/02-manual/07-puesta-en-marcha" | relative_url }}) — secuencia de arranque
6. [Estado actual]({{ "/docs/02-manual/10-estado-actual" | relative_url }}) y [Pendientes]({{ "/docs/02-manual/11-pendientes" | relative_url }})
